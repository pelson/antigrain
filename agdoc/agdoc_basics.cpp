...
namespace agdoc
{
    ...
    //------------------------------------------------------------------
    parsing_exception::parsing_exception(const char* msg) : 
        m_line_num(-1)
    {
        copy_message(msg);
    }
    ...
    //------------------------------------------------------------------
    parsing_exception::parsing_exception(const src_line& line, const char* msg) :
        m_line_num(line.num)
    {
        copy_message(msg);
    ...
    //------------------------------------------------------------------
    void parsing_exception::copy_message(const char* msg)
    {
    ...
    //------------------------------------------------------------------
    void element::throw_exception(const char_type* ptr, const char* msg) const
    {
    ...
    //------------------------------------------------------------------
    char_type* element::parse_nested(char* text)
    {
        if(text == 0) return 0;
        m_content = text;
        while(*text)
...
*/
    ...
    //------------------------------------------------------------------
    config::config(const char* file_name, bool trim_flag) : 
        m_level(0),
    ...
    //------------------------------------------------------------------
    void config::content(const element& e, 
    ...
    //------------------------------------------------------------------
    void log_file::write(const char* message)
    {
        puts(message);
        puts("");
    }
    ...
    //------------------------------------------------------------------
    void log_file::write(const char* message, const char_type* arg1)
    {
