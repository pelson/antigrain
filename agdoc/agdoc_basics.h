...
namespace agdoc
{
    ...
    {
        config_exception(const src_line& line, const char* msg) : 
    ...
    {
        file_not_found(const char* msg) : parsing_exception(msg) {}
    };
    ...
    {
    public:
        config(const char* file_name, bool trim_flag);
    ...
    public:
        ...
        void write(const char* message, const char_type* arg1);
        void write(const char* message, const char_type* arg1, 
                                        const char_type* arg2);
    };
